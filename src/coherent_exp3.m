...
D = diag([exp( pi*j*sin(array_1)),exp( pi*j*sin(array_2)),exp( pi*j*sin(array_3))]);
SNRMinimun = -10;
SNRMaximun = 10;
...
%         Signal_0 = sin(2*pi*50*t);
        ...
        ATimesDkSquarekMinusOneTimesRouTimesSignal_0 = A * Dk^(k-1) * rou * Signal_0; 
