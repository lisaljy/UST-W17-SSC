...
array_2Minimun = 1;
array_2Maximun = 10;
x = array_2Minimun:1:array_2Maximun;
SNR = 15;
MonteNum = 1000;
ProbabilityAIC = [];
ProbabilityMDL = [];
...
for array_2 = array_2Minimun:array_2Maximun
    % array_2=10;
    % Signal Model
    % X = A * Signal + Noise;
...
hold on;
title('Detection Probability of non-coherent signal versus Different anaglar differences');
xlabel('Distance between anagles(Degree)');
